...
function I(n2, l3, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  for (f4 = P(u4, l3, m3, f4, b), a3 = 0; a3 < b; a3++)
    null != (y2 = u4.__k[a3]) && (h3 = -1 == y2.__i ? p : m3[y2.__i] || p, y2.__i = a3, g2 = O(n2, y2, h3, i4, r3, o3, e3, f4, c3, s3), w3 = y2.__e, y2.ref && h3.ref != y2.ref && (h3.ref && B(h3.ref, null, y2), s3.push(y2.ref, y2.__c || w3, y2)), null == d3 && null != w3 && (d3 = w3), (_2 = !!(4 & y2.__u)) || h3.__k === y2.__k ? f4 = A(y2, f4, n2, _2) : "function" == typeof y2.type && void 0 !== g2 ? f4 = g2 : w3 && (f4 = w3.nextSibling), y2.__u &= -7);
  return u4.__e = d3, f4;
}
function P(n2, l3, u4, t3, i4) {
  ...
  if (a3)
    for (r3 = 0; r3 < s3; r3++)
      null != (e3 = u4[r3]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = S(e3)), D(e3, e3));
  return t3;
}
...
function L(n2, l3, u4, t3) {
  ...
  if (null === c3 && null == n2.key || s3 && e3 == c3.key && f4 == c3.type)
    return u4;
  if (t3 > (s3 ? 1 : 0)) {
...
function O(n2, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  var a3, h3, p3, v3, y2, _2, m3, b, S2, C2, M2, $2, P2, A2, H, L2, T2, j3 = u4.type;
  ...
  n:
    if ("function" == typeof j3)
      try {
        if (b = u4.props, S2 = "prototype" in j3 && j3.prototype.render, C2 = (a3 = j3.contextType) && i4[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i4, t3.__c ? m3 = (h3 = u4.__c = t3.__c).__ = h3.__E : (S2 ? u4.__c = h3 = new j3(b, M2) : (u4.__c = h3 = new x(b, M2), h3.constructor = j3, h3.render = E), C2 && C2.sub(h3), h3.props = b, h3.state || (h3.state = {}), h3.context = M2, h3.__n = i4, p3 = h3.__d = true, h3.__h = [], h3._sb = []), S2 && null == h3.__s && (h3.__s = h3.state), S2 && null != j3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, j3.getDerivedStateFromProps(b, h3.__s))), v3 = h3.props, y2 = h3.state, h3.__v = u4, p3)
        ...
        if (h3.context = M2, h3.props = b, h3.__P = n2, h3.__e = false, P2 = l.__r, A2 = 0, S2) {
          for (h3.state = h3.__s, h3.__d = false, P2 && P2(u4), a3 = h3.render(h3.props, h3.state, h3.context), H = 0; H < h3._sb.length; H++)
        ...
        h3.state = h3.__s, null != h3.getChildContext && (i4 = d(d({}, i4), h3.getChildContext())), S2 && !p3 && null != h3.getSnapshotBeforeUpdate && (_2 = h3.getSnapshotBeforeUpdate(v3, y2)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = V(a3.props.children)), f4 = I(n2, w(L2) ? L2 : [L2], u4, t3, i4, r3, o3, e3, f4, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && e3.push(h3), m3 && (h3.__E = h3.__ = null);
      } catch (n3) {
        if (u4.__v = null, c3 || null != o3)
          ...
          u4.__e = t3.__e, u4.__k = t3.__k, n3.then || z(u4);
        l.__e(n3, u4, t3);
      }
    else
      null == o3 && u4.__v == t3.__v ? (u4.__k = t3.__k, u4.__e = t3.__e) : f4 = u4.__e = q(t3.__e, u4, t3, i4, r3, o3, e3, c3, s3);
...
function q(u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  var a3, h3, v3, y2, d3, _2, m3, b = i4.props, k3 = t3.props, x2 = t3.type;
  ...
  if (null == x2)
    ...
    if (e3 = e3 && n.call(u4.childNodes), b = i4.props || p, !c3 && null != e3)
      for (b = {}, a3 = 0; a3 < u4.attributes.length; a3++)
        b[(d3 = u4.attributes[a3]).name] = d3.value;
    for (a3 in b)
    ...
    for (a3 in k3)
      d3 = k3[a3], "children" == a3 ? y2 = d3 : "dangerouslySetInnerHTML" == a3 ? h3 = d3 : "value" == a3 ? _2 = d3 : "checked" == a3 ? m3 = d3 : c3 && "function" != typeof d3 || b[a3] === d3 || j(u4, a3, d3, b[a3], o3);
    if (h3)
      c3 || v3 && (h3.__html == v3.__html || h3.__html == u4.innerHTML) || (u4.innerHTML = h3.__html), t3.__k = [];
    else if (v3 && (u4.innerHTML = ""), I("template" == t3.type ? u4.content : u4, w(y2) ? y2 : [y2], t3, i4, r3, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o3, e3, f4, e3 ? e3[0] : i4.__k && S(i4, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
// _js/color-picker.jsx
function ColorPicker() {
  const colors = ["#3498db", "#e74c3c", "#2ecc71", "#f39c12", "#9b59b6", "#1abc9c"];
  const [selectedColor, setSelectedColor] = d2(colors[0]);
  return /* @__PURE__ */ u3("div", { style: { margin: "20px 0" }, children: [
    /* @__PURE__ */ u3(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ u3("div", { style: { display: "flex", gap: "10px", flexWrap: "wrap" }, children: colors.map((color) => /* @__PURE__ */ u3(
      "button",
      {
    ...
    /* @__PURE__ */ u3("p", { style: { marginTop: "10px", fontFamily: "monospace" }, children: [
      "Selected: ",
      selectedColor
    ] })
  ] });
...
if (typeof window !== "undefined") {
  ...
  if (container) {
    G(/* @__PURE__ */ u3(ColorPicker, {}), container);
  }
}
