...
function I(n2, l3, u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  for (f4 = P(u4, l3, m3, f4, b), a3 = 0; a3 < b; a3++)
    null != (y3 = u4.__k[a3]) && (h3 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h3, i4, r3, o3, e3, f4, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && B(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), (_2 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f4 = A(y3, f4, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f4 = g2 : w3 && (f4 = w3.nextSibling), y3.__u &= -7);
  return u4.__e = d3, f4;
}
...
function q(u4, t3, i4, r3, o3, e3, f4, c3, s3) {
  ...
  if (null == x2)
    ...
    for (a3 in k3)
      d3 = k3[a3], "children" == a3 ? y3 = d3 : "dangerouslySetInnerHTML" == a3 ? h3 = d3 : "value" == a3 ? _2 = d3 : "checked" == a3 ? m3 = d3 : c3 && "function" != typeof d3 || b[a3] === d3 || j(u4, a3, d3, b[a3], o3);
    if (h3)
      c3 || v3 && (h3.__html == v3.__html || h3.__html == u4.innerHTML) || (u4.innerHTML = h3.__html), t3.__k = [];
    else if (v3 && (u4.innerHTML = ""), I("template" == t3.type ? u4.content : u4, w(y3) ? y3 : [y3], t3, i4, r3, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o3, e3, f4, e3 ? e3[0] : i4.__k && S(i4, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
var SAVED_MESSAGE_DURATION = 2e3;
function Demo({ fsyncMode = false }) {
  ...
  function FavoriteColorSelector() {
    ...
    return /* @__PURE__ */ u3("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      "\u{1F9D1} (User) My favorite color is:",
      isShowingSpinner ? /* @__PURE__ */ u3("span", { style: {
        ...
        "select",
        {
          ...
          onChange: (e3) => setState((prevState) => ({ ...prevState, favColor: e3.target.value })),
          style: {
            marginLeft: "8px",
            padding: "4px",
  ...
  function CachedColorDisplay() {
    return /* @__PURE__ */ u3("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
      /* @__PURE__ */ u3("div", { children: [
        "\u{1F916} (Cache) User's favorite color is: ",
        /* @__PURE__ */ u3("span", { style: { color: state.cachedFavColor }, children: state.cachedFavColor })
      ] }),
      state.flushingColor !== null && /* @__PURE__ */ u3("span", { style: {
  ...
  function DiskColorDisplay() {
    return /* @__PURE__ */ u3("div", { children: [
      "\u{1F4BE} (Disk) User's favorite color is: ",
...
if (typeof window !== "undefined") {
  ...
  if (container) {
    G(/* @__PURE__ */ u3(Demo, {}), container);
  }
  const fsyncContainer = document.getElementById("demo-fsync-app");
  if (fsyncContainer) {
    G(/* @__PURE__ */ u3(Demo, { fsyncMode: true }), fsyncContainer);
  }
}
